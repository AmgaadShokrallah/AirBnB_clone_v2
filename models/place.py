...
class Place(BaseModel, Base):
    ...
    Attributes:
        __tablename__ (str): The name store places.
        ...
        number_rooms (sqlalchemy Integer): The num of rooms.
        number_bathrooms (sqlalchemy Integer): The num of bathrooms.
        max_guest (sqlalchemy Integer): The maximum num of guests.
